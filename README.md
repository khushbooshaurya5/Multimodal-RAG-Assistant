...
├── scripts/                ingest.py · query.py · evaluate.py · download_models.py · deploy_hf_space.sh
├── docs/                   ARCHITECTURE.md · EVALUATION.md · PORTFOLIO.md · screenshots/
├── deploy/huggingface/     Space card and apt packages for scripts/deploy_hf_space.sh
